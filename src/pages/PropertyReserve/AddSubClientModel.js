...
const AddSubAgentModel = ({ addInputField, handleInputChange, inputFields, removeInputField, handleclosesubclient, handleSaveClientForm }) => {
                    ...
                    <div className={`modal-dialog modal-dialog-centered ${modalSize}`}>
                        <div className="modal-content">
                            <div className="modal-header py-0 px-2">
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={handleclosesubclient}></button>
                            </div>
                            <div className="d-flex justify-content-center align-items-center">  
                                ...
                                <h3 className="m-0 mt-1 text-center" style={{ color: '#304B64', fontWeight: 'bold' }}>Add Shasred Client</h3>
                            </div>
                            <div className="text-center"><h5 style={{ color: '#304B64', fontWeight: 'bold' }}>(Up to 10 shared Clients)</h5></div>
                            <div className="modal-body px-0">
                                {inputFields?.map((item, index) => (
                                    <div className="row mb-4" key={index}>
                                        <hr className="text-muted"></hr>
                                        <div className="col-md-4 col-sm-6 mb-3 px-4">
                                            <label htmlFor={`firstName_${index}`} className="form-label fw-bolder">Client Full Name*</label>
                                            <input
                            ...
                            <div className="modal-footer">
                                <hr></hr>
                                <Button style={{ fontSize: '18px', marginRight: '30px' }} variant="link" text="Cancel" onClick={handleclosesubclient} />
